...
func TestBasic(t *testing.T) {
	...
	t.Run("TestGetString", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive string, received error: %v\n", err)
		}
		if v == "" {
	...
	t.Run("TestGetBool", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive bool, received error: %v\n", err)
		}
		if v != true {
	...
	t.Run("TestGetUUID", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive uuid, received error: %v\n", err)
		}
		if v == uuid.Nil {
	...
	t.Run("TestGetRune", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive rune, received error: %v\n", err)
		}
		if v == nil {
	...
	t.Run("TestGetBytes", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive bytes, received error: %v\n", err)
		}
		if len(v) == 0 {
	...
	t.Run("TestGetDuration", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive duration, received error: %v\n", err)
		}
	...
	t.Run("TestGetInt", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive int, received error: %v\n", err)
		}
		if v == 0 {
	...
	t.Run("TestGetInt8", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive int8, received error: %v\n", err)
		}
		if v == 0 {
			t.Errorf("Expected to receive integer != 0, received %v\n", v)
		}
	...
	t.Run("TestGetInt16", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive int16, received error: %v\n", err)
		}
		if v == 0 {
			t.Errorf("Expected to receive integer != 0, received %v\n", v)
		}
	...
	t.Run("TestGetInt32", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive int32, received error: %v\n", err)
		}
		if v == 0 {
			t.Errorf("Expected to receive integer != 0, received %v\n", v)
		}
	...
	t.Run("TestGetInt64", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive int64, received error: %v\n", err)
		}
		if v == 0 {
			t.Errorf("Expected to receive integer != 0, received %v\n", v)
		}
	...
	t.Run("TestGetUint", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive uint, received error: %v\n", err)
		}
		if v == 0 {
			t.Errorf("Expected to receive integer != 0, received %v\n", v)
		}
	...
	t.Run("TestGetUint8", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive uint8, received error: %v\n", err)
		}
		if v == 0 {
			t.Errorf("Expected to receive integer != 0, received %v\n", v)
		}
	...
	t.Run("TestGetUint16", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive uint16, received error: %v\n", err)
		}
		if v == 0 {
			t.Errorf("Expected to receive integer != 0, received %v\n", v)
		}
	...
	t.Run("TestGetUint32", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive uint32, received error: %v\n", err)
		}
		if v == 0 {
			t.Errorf("Expected to receive integer != 0, received %v\n", v)
		}
	...
	t.Run("TestGetUint64", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive uint64, received error: %v\n", err)
		}
		if v == 0 {
			t.Errorf("Expected to receive integer != 0, received %v\n", v)
		}
	...
	t.Run("TestGetFloat32", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive float32, received error: %v\n", err)
		}
		if v == 0 {
	...
	t.Run("TestGetFloat64", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive float64, received error: %v\n", err)
		}
		if v == 0 {
	...
	t.Run("TestGetComplex64", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive complex64, received error: %v\n", err)
		}
		if v == 0 {
	...
	t.Run("TestGetComplex128", func(t *testing.T) {
		...
		if err != nil {
			t.Errorf("Expected to receive complex128, received error: %v\n", err)
		}
		if v == 0 {
